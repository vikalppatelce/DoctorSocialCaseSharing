...
* P3MX01    VIKALP PATEL  27/03/2014     IMPROVE            ADDED IMAGE RESIZE SETTINGS
* P3AG1     VIKALP PATEL  09/04/2014     AGGRESSIVE         APPLICATION PESTERING TO LOGIN
* P3B02     VIKALP PATEL  21/04/2014     BUG                AGRESSIVE SERVICE START
* --------------------------------------------------------------------------------------------------------------------
*/
...
//		SA P3MX03
		Preference helpSetup = prefMgr.findPreference("prefHelpSetup");
		if(helpSetup!=null)
		{
			helpSetup.setOnPreferenceClickListener(new Preference.OnPreferenceClickListener() {
...
//	    			emailIntent.putExtra(android.content.Intent.EXTRA_EMAIL,new String[] { "feedback@smarthumanoid.com" });
	    			String user = SmartConsultant.getApplication().getPreferences().getUserLoginDTO().getUserName();
	    			String body="";
...
//	        SA P2M01
	        if (p instanceof ListPreference) {
	            ...
	            String whichList = syncListPref.getKey();
...
//				}
				...
				if(whichList.equalsIgnoreCase("prefListSyncFrequency"))
				{
					switch(Integer.parseInt(s))
					{
					case 0:
					...
					case 4:
						...
						break;
					case 5:
						p.setSummary("Never (Update manually)");
						break;
					}
				}
				else
				{
					...
					case 0:
						...
						break;
					case 1:
						p.setSummary("Very Small");
						break;
					case 2:
						p.setSummary("Small");
						break;
					case 3:
						p.setSummary("As it is");
						break;
					}
...
//		 SA P2M01
		 if (key.equals("prefListSyncFrequency")) {
				...
				if (preference instanceof ListPreference) {
					...
					ServiceAlarm serviceAlarm = new ServiceAlarm();//ADDED P3B02
...
//		 SA P3MX01
		 if (key.equals("prefListResizeImage")) {
				Preference preference = findPreference(key);
				if (preference instanceof ListPreference) {
					ListPreference resizeImageList = (ListPreference) preference;
					
					String s = resizeImageList.getValue();
					
					SmartConsultant.getPreferences().setResizeImage(s);
									}
			}
//		 EA P2M01
