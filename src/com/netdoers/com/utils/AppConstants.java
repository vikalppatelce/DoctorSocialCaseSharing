...
//		public static final String SOCIAL_URL =  "https://smarthumanoid.com/consultant/sharing/cases.php?user_id=";
	...
	public static final String IMAGE_DIRECTORY_PATH = Environment.getExternalStorageDirectory().getPath()+"/SmartConsultant";
	public static final String IMAGE_DIRECTORY_PATH_DATA = SmartConsultant.getApplication().getApplicationContext().getFilesDir().getAbsolutePath();
