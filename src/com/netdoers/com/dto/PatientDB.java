 ...
 * P3A02      VIKALP PATEL     21/03/2014       PHASE-III       ADDED SHARED COLUMN FOR PHASE - III
 * DB001	  VIKALP PATEL     23/04/2014       MODIFICATION    ADDED DEFAULT EMERGENCY IN PATIENT TEMP & SERVICE TABLE
 * P3A03      VIKALP PATEL     05/05/2014       PHASE-III       ADDED SHARE CONTACT TABLE
 * P3A04      VIKALP PATEL     06/05/2014       PHASE-III       ADDED SHARE CONTACT PRIVACY IN SERVICE AND PATIENT TABLE
 * --------------------------------------------------------------------------------------------------------------------
 */
...
public class PatientDB extends ContentProvider{
	...
	private static final int PATIENTCONTACTDETAILS = 22;//SA P3A03
	private static final int PATIENTTEMPCONTACTDETAILS = 23;//EA P3A03
	...
	private static HashMap<String, String> patientContactDetailsProjectionMap;//SA P3A03
	private static HashMap<String, String> patientTempContactDetailsProjectionMap;//EA P3A03
...
//			strBuilder.append(DBConstant.Types_Columns.COLUMN_ID +" INTEGER(20) PRIMARY KEY NOT NULL DEFAULT (STRFTIME('%s',CURRENT_TIMESTAMP))," ); //EU10001
			...
			strBuilder.append(DBConstant.Expeses_Details_Columns.COLUMN_SYNC_STATUS +" NUMBER ," );//ADDED A0001
...
//			strBuilder.append(DBConstant.Patient_Columns.COLUMN_ADDRESS +" TEXT ," );
			...
			strBuilder.append(DBConstant.Patient_Columns.COLUMN_EMERGENCY +" NUMBER DEFAULT 0," );
			...
			strBuilder.append(DBConstant.Patient_Columns.COLUMN_SHARING +" NUMBER DEFAULT 0, " );//ADDED P3A02
			strBuilder.append(DBConstant.Patient_Columns.COLUMN_SHARING_PRIVATE +" NUMBER DEFAULT 0, " );//ADDED P3A04
			...
			strBuilder.append(DBConstant.Patient_Temp_Columns.COLUMN_EMERGENCY +" NUMBER DEFAULT 0," );
			...
			strBuilder.append(DBConstant.Patient_Temp_Columns.COLUMN_TOTALCOUNT +" NUMBER ," );
			strBuilder.append(DBConstant.Patient_Temp_Columns.COLUMN_SHARING +" NUMBER DEFAULT 0, " );//ADDED P3A02
			strBuilder.append(DBConstant.Patient_Columns.COLUMN_SHARING_PRIVATE +" NUMBER DEFAULT 0, " );//ADDED P3A04
...
//			SA P3A03
			...
			strBuilder = new StringBuilder();
			strBuilder.append("CREATE TABLE ");
			strBuilder.append(DBConstant.TABLE_PATIENT_CONTACT);
			strBuilder.append('(');
			strBuilder.append(DBConstant.Patient_Contact_Columns.COLUMN_ID+ " INTEGER(20) NOT NULL DEFAULT (STRFTIME('%s',CURRENT_TIMESTAMP)),"); 
			strBuilder.append(DBConstant.Patient_Contact_Columns.COLUMN_PATIENT_ID+ " TEXT ,");
			strBuilder.append(DBConstant.Patient_Contact_Columns.COLUMN_CONTACT_TYPE+ " NUMBER DEFAULT 0,");
			strBuilder.append(DBConstant.Patient_Contact_Columns.COLUMN_SYNC_STATUS+ " NUMBER DEFAULT 0,");
			strBuilder.append(DBConstant.Patient_Contact_Columns.COLUMN_CONTACT_NUMBER+ " NUMBER ,");
			strBuilder.append(DBConstant.Patient_Contact_Columns.COLUMN_CONTACT_NAME+ " TEXT");
			strBuilder.append(')');
			db.execSQL(strBuilder.toString());
			Log.i("Patient_Contact_Details", strBuilder.toString());			
			
			// patient temp contact details
			strBuilder = new StringBuilder();
			strBuilder.append("CREATE TABLE ");
			strBuilder.append(DBConstant.TABLE_PATIENT_TEMP_CONTACT);
			strBuilder.append('(');
			strBuilder.append(DBConstant.Patient_Temp_Contact_Columns.COLUMN_ID+ " INTEGER(20) NOT NULL DEFAULT (STRFTIME('%s',CURRENT_TIMESTAMP)),"); 
			strBuilder.append(DBConstant.Patient_Temp_Contact_Columns.COLUMN_PATIENT_ID+ " TEXT ,");
			strBuilder.append(DBConstant.Patient_Temp_Contact_Columns.COLUMN_CONTACT_TYPE+ " NUMBER DEFAULT 0,");
			strBuilder.append(DBConstant.Patient_Temp_Contact_Columns.COLUMN_SYNC_STATUS+ " NUMBER DEFAULT 0,");
			strBuilder.append(DBConstant.Patient_Temp_Contact_Columns.COLUMN_CONTACT_NUMBER+ " NUMBER ,");
			strBuilder.append(DBConstant.Patient_Temp_Contact_Columns.COLUMN_CONTACT_NAME+ " TEXT");
			strBuilder.append(')');
			db.execSQL(strBuilder.toString());
			Log.i("Patient_Temp_Contact_Details", strBuilder.toString());			
			//EA P3A03
		...
		public void onUpgrade(SQLiteDatabase db, int oldVersion, int newVersion) {
			...
			db.execSQL("DROP TABLE IF EXISTS " + DBConstant.TABLE_PATIENT_CONTACT);//SA P3A03
			db.execSQL("DROP TABLE IF EXISTS " + DBConstant.TABLE_PATIENT_TEMP_CONTACT);//EA P3A03
			
			onCreate(db);
		}
	}

	private static final int DATABASE_VERSION = 9;//[ 2-v1.3 | 5- v2.0 | 6- v2.1 | 7 - 2.1(BUG-EMERGENCY) | 8 - V2.2]
	...
	public int delete(Uri uri, String where, String[] whereArgs) {
		...
		case PATIENTPERDETAILS:
			...
			//EA 10006
//			SA P3A03
		case PATIENTCONTACTDETAILS:
			count = db.delete(DBConstant.TABLE_PATIENT_CONTACT, where, whereArgs);
			break;
		case PATIENTTEMPCONTACTDETAILS:
			count = db.delete(DBConstant.TABLE_PATIENT_TEMP_CONTACT, where, whereArgs);
			break;
//			EA P3A03
		default:
	...
	public String getType(Uri uri) {
		...
		case PATIENTPERDETAILS:
			...
			//SA P3A03
		case PATIENTCONTACTDETAILS:
			return DBConstant.Patient_Contact_Columns.CONTENT_TYPE;
		case PATIENTTEMPCONTACTDETAILS:
			return DBConstant.Patient_Temp_Contact_Columns.CONTENT_TYPE;
			//EA P3A03
		default:
			throw new IllegalArgumentException("Unknown URI " + uri);
		}
	...
	public Uri insert(Uri uri, ContentValues initialValues) {
		...
		if (sUriMatcher.match(uri) != LOCATION && sUriMatcher.match(uri) != PROCEDURE
		    ...
		    && sUriMatcher.match(uri) != PATIENTCONTACTDETAILS && sUriMatcher.match(uri) != PATIENTTEMPCONTACTDETAILS//ADDED P3A03
		...
		switch (sUriMatcher.match(uri)) 
		{
			...
			case PATIENTPERDETAILS:
				...
				//SA P3A03
			case PATIENTCONTACTDETAILS:
				 rowId = db.insert(DBConstant.TABLE_PATIENT_CONTACT, null, values);
				if (rowId > 0) 
				{
					Uri noteUri = ContentUris.withAppendedId(DBConstant.Patient_Contact_Columns.CONTENT_URI, rowId);
					getContext().getContentResolver().notifyChange(noteUri, null);
					return noteUri;
				}
				break;
			case PATIENTTEMPCONTACTDETAILS:
				 rowId = db.insert(DBConstant.TABLE_PATIENT_TEMP_CONTACT, null, values);
				if (rowId > 0) 
				{
					Uri noteUri = ContentUris.withAppendedId(DBConstant.Patient_Temp_Contact_Columns.CONTENT_URI, rowId);
					getContext().getContentResolver().notifyChange(noteUri, null);
					return noteUri;
				}
				break;
	...
	public Cursor query(Uri uri, String[] projection, String selection, String[] selectionArgs, String sortOrder) {
		...
		case PATIENTPERDETAILS:
            ...
            //SA P3A03			
		case PATIENTCONTACTDETAILS:
			qb.setTables(DBConstant.TABLE_PATIENT_CONTACT);
			qb.setProjectionMap(patientContactDetailsProjectionMap);
			break;
		case PATIENTTEMPCONTACTDETAILS:
			qb.setTables(DBConstant.TABLE_PATIENT_TEMP_CONTACT);
			qb.setProjectionMap(patientTempContactDetailsProjectionMap);
			break;
			//EA P3A03
		default:
			throw new IllegalArgumentException("Unknown URI " + uri);
...
//		SQLiteDatabase db = openHelper.getReadableDatabase(); //COMMENTED 1000A
	...
	public int update(Uri uri, ContentValues values, String where, String[] whereArgs) {
		...
		case PATIENTPERDETAILS:
			...
			//SA P3A03
		case PATIENTCONTACTDETAILS:
			count = db.update(DBConstant.TABLE_PATIENT_CONTACT, values, where, whereArgs);
			break;
		case PATIENTTEMPCONTACTDETAILS:
			count = db.update(DBConstant.TABLE_PATIENT_TEMP_CONTACT, values, where, whereArgs);
			break;			
			//EA P3A03
		default:
			throw new IllegalArgumentException("Unknown URI " + uri);
	...
	static {
		...
		//SA P3A03
		sUriMatcher.addURI(AUTHORITY, DBConstant.TABLE_PATIENT_CONTACT, PATIENTCONTACTDETAILS);
		sUriMatcher.addURI(AUTHORITY, DBConstant.TABLE_PATIENT_TEMP_CONTACT, PATIENTTEMPCONTACTDETAILS);
		//EA P3A03
...
//		patientProjectionMap.put(DBConstant.Patient_Columns.COLUMN_FEES, DBConstant.Patient_Columns.COLUMN_FEES);
		...
		patientProjectionMap.put(DBConstant.Patient_Columns.COLUMN_SHARING, DBConstant.Patient_Columns.COLUMN_SHARING);//ADDED P3A02
		patientProjectionMap.put(DBConstant.Patient_Columns.COLUMN_SHARING_PRIVATE, DBConstant.Patient_Columns.COLUMN_SHARING_PRIVATE);//ADDED P3A04
		...
		patientTempProjectionMap.put(DBConstant.Patient_Temp_Columns.COLUMN_SHARING, DBConstant.Patient_Temp_Columns.COLUMN_SHARING);//ADDED P3A02
		patientTempProjectionMap.put(DBConstant.Patient_Temp_Columns.COLUMN_SHARING_PRIVATE, DBConstant.Patient_Temp_Columns.COLUMN_SHARING_PRIVATE);//ADDED P3A04
		...
		//SA P3A03
		patientContactDetailsProjectionMap = new HashMap<String, String>();
		patientContactDetailsProjectionMap.put(DBConstant.Patient_Contact_Columns.COLUMN_ID, DBConstant.Patient_Contact_Columns.COLUMN_ID);
		patientContactDetailsProjectionMap.put(DBConstant.Patient_Contact_Columns.COLUMN_PATIENT_ID, DBConstant.Patient_Contact_Columns.COLUMN_PATIENT_ID);
		patientContactDetailsProjectionMap.put(DBConstant.Patient_Contact_Columns.COLUMN_CONTACT_TYPE, DBConstant.Patient_Contact_Columns.COLUMN_CONTACT_TYPE);
		patientContactDetailsProjectionMap.put(DBConstant.Patient_Contact_Columns.COLUMN_CONTACT_NAME, DBConstant.Patient_Contact_Columns.COLUMN_CONTACT_NAME);
		patientContactDetailsProjectionMap.put(DBConstant.Patient_Contact_Columns.COLUMN_SYNC_STATUS, DBConstant.Patient_Contact_Columns.COLUMN_SYNC_STATUS);
		patientContactDetailsProjectionMap.put(DBConstant.Patient_Contact_Columns.COLUMN_CONTACT_NUMBER, DBConstant.Patient_Contact_Columns.COLUMN_CONTACT_NUMBER);
		
		patientTempContactDetailsProjectionMap = new HashMap<String, String>();
		patientTempContactDetailsProjectionMap.put(DBConstant.Patient_Temp_Contact_Columns.COLUMN_ID, DBConstant.Patient_Temp_Contact_Columns.COLUMN_ID);
		patientTempContactDetailsProjectionMap.put(DBConstant.Patient_Temp_Contact_Columns.COLUMN_PATIENT_ID, DBConstant.Patient_Temp_Contact_Columns.COLUMN_PATIENT_ID);
		patientTempContactDetailsProjectionMap.put(DBConstant.Patient_Temp_Contact_Columns.COLUMN_CONTACT_TYPE, DBConstant.Patient_Temp_Contact_Columns.COLUMN_CONTACT_TYPE);
		patientTempContactDetailsProjectionMap.put(DBConstant.Patient_Temp_Contact_Columns.COLUMN_CONTACT_NAME, DBConstant.Patient_Temp_Contact_Columns.COLUMN_CONTACT_NAME);
		patientTempContactDetailsProjectionMap.put(DBConstant.Patient_Temp_Contact_Columns.COLUMN_SYNC_STATUS, DBConstant.Patient_Temp_Contact_Columns.COLUMN_SYNC_STATUS);
		patientTempContactDetailsProjectionMap.put(DBConstant.Patient_Temp_Contact_Columns.COLUMN_CONTACT_NUMBER, DBConstant.Patient_Temp_Contact_Columns.COLUMN_CONTACT_NUMBER);
		//EA P3A03
	}	
}
