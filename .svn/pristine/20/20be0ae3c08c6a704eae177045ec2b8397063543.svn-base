...
public class ServiceDelegate {
	...
	public static String postRecordedFile1(String type, File file, JSONObject json, String url) throws UnsupportedEncodingException, ClientProtocolException, IOException{
		...
		//SA S0001
		String hash = SmartConsultant.getPreferences().getUserLoginDTO().getPassHash();
		FormBodyPart bodyPart1 = new FormBodyPart("hash", new StringBody(hash));
		
		String deviceID = SmartConsultant.getPreferences().getDeviceId();
		FormBodyPart bodyPart2 = new FormBodyPart("device_id", new StringBody(deviceID));
		//EA S0001
		reqEntity.addPart(bodyPart);
		reqEntity.addPart(bodyPart1);//SA S0001
		reqEntity.addPart(bodyPart2);//EA S0001
