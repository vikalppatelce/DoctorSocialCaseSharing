 ...
 * P3B05       VIKALP PATEL    21/04/2014        BUG            DUPLICATE VALUES IN PATIENT NAME
 ...
 * P3B10       VIKALP PATEL    16/05/2014        BUG            SHARED PRIVATE VISIBLE  
 * --------------------------------------------------------------------------------------------------------------------
 */
...
//		                    Toast.makeText(SmartConsultant.getApplication().getApplicationContext(), "Right Swipe", Toast.LENGTH_SHORT).show();
	...
	//SA U0001
			...
			public void setText()
			{
				txtTitle.setText("OPD Search " + (currentRecord+1) +" of " + (serviceCursor.getCount()+1));
			}
				...
				if(serviceCursor != null && serviceCursor.getCount() > index)
				{
					...
					if(contactsCursor != null && contactsCursor.getCount() > 0)
					{
						...
						while (iterContacts.hasNext()) {
								...
								TextView t = new TextView(AddOPDSearchActivity.this);
...
//	SA P3A03
	...
	{
		Intent contactPicker = new Intent(AddOPDSearchActivity.this, ContactManager.class);
		startActivityForResult(contactPicker, IMPORT_CONTACT);
	}
...
//				sex = "Female";
			...
			//SA U0001
			serviceValues.put(DBConstant.Patient_Columns.COLUMN_SERVICE_TYPE, "0");
			patientValues.put(DBConstant.Patient_Temp_Columns.COLUMN_SERVICE_TYPE, "0");
			//EA U0001
