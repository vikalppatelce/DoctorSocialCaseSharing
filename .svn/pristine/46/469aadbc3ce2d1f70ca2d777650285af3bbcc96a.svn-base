 ...
 * P3MX01      VIKALP PATEL    27/03/2014        IMPROVE        ADDED SWITCH INSTEAD OF RADIOGROUP AND CHECKBOXES
 ...
 * P3B06       VIKALP PATEL    23/04/2014        BUG            UPDATING PATIENT TEMP TABLE
		...
		gallery.setOnItemClickListener(new OnItemClickListener() {
			...
			public void onItemClick(AdapterView<?> arg0, View arg1, int arg2,
				...
				if (extension.equalsIgnoreCase("mp4")) {
					...
					Intent intent = new Intent(AddSxSearchActivity.this,
							DetailedImage.class);
...
//		btnFemale = (RadioButton) findViewById(R.id.radioFemale);//SWITCH
...
//	                    Toast.makeText(SmartConsultant.getApplication().getApplicationContext(), "Right Swipe", Toast.LENGTH_SHORT).show();
	...
	//SA U0001
			...
			public void setText()
			{
				txtTitle.setText("SX Search " + (currentRecord+1) +" of " + (serviceCursor.getCount()+1));
			}
						...
						for(int i = 0; i < paths.size(); i++)
						{
							...
							if (extension.equalsIgnoreCase("mp4")) {
								...
								try {
									...
									AddSxSearchActivity.this.data.add(GalleryMedia.drawableToBitmap(GalleryMedia.geSingleDrawable(layerDrawable)));
								}
								catch(Exception e)
								{
				...
				if(serviceCursor != null && serviceCursor.getCount() > index)
				{
					...
					if(contactsCursor != null && contactsCursor.getCount() > 0)
					{
						...
						while (iterContacts.hasNext()) {
								...
								TextView t = new TextView(AddSxSearchActivity.this);
...
//	SA P3A03
	...
	{
		Intent contactPicker = new Intent(AddSxSearchActivity.this, ContactManager.class);
		startActivityForResult(contactPicker, IMPORT_CONTACT);
	}
...
//				sex = "Female"; 
			...
			//SA U0001
			serviceValues.put(DBConstant.Patient_Columns.COLUMN_SERVICE_TYPE, "2");
			patientValues.put(DBConstant.Patient_Temp_Columns.COLUMN_SERVICE_TYPE, "2");
			//EA U0001
